...
class Footer extends Component {
  render() {
    return (
      <div className="flex p-20 bg-black text-white justify-between mt-11">
        <div className="space-y-4">
          ...
          <p className="text-[16px] text-[#A1A1AA]">
            ...
            industry. Lorem <br />Ipsum has been the industry's standard <br /> dummy text
        ...
        <div className="space-y-4">
            ...
            <div className="text-[16px] text-[#A1A1AA] space-y-4">
              <p><i className="fa-brands fa-square-x-twitter"></i> @CS — Ticket System</p>
              <p><i className="fa-brands fa-linkedin"></i> @CS — Ticket System</p>
              <p><i className="fa-brands fa-facebook"></i> @CS — Ticket System</p>
              <p><i className="fa-solid fa-envelope"></i> support@cst.com</p>
            </div>
        </div>
      </div>
    );
